Public Class mini_ANTI_KIKANSYA
    Inherits ItemBase
    Public Overrides ReadOnly Property ID As Integer = 16
    Public Overrides ReadOnly Property Name As String = "ミニ反転機関車"
    Public Overrides ReadOnly Property rarity As Integer = 4     'アイテムのレアリティ(ショップの並びやすさ)
    Public Overrides Property Gold As Integer = 23   'アイテム購入の費用　売却は半分で売れる。
